...
spawn(function() 
    ...
    wait(1.5)
    require(game.ReplicatedStorage.Notification).new("<Color=Red>BCV Luxury chào ae<Color=/>"):Display()
    wait(.5)
...
local Window = OrionLib:MakeWindow({Name = "BCV Luxury", HidePremium = false, IntroText = "BCV Luxury⚜️", SaveConfig = true, ConfigFolder = "NightHub"})
...
W:AddLabel("BCV Luxury SCRIPT")
W:AddLabel("DiscordBCV Luxury")
local Section = W:AddSection({
    Name = "Status"
})
